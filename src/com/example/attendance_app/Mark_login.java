...
public class Mark_login extends Activity{
	...
	static Mark_login activityMain;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_mark_login);
		activityMain = this;
              ...
              // Use UrlEncodedFormEntity to send in proper format which we need
				...
				if(ans.equalsIgnoreCase("1")){
					Intent intent = new Intent(getApplicationContext(),
    						Mark_Attendance_Activity.class);					
	...
	private class GetAttendance extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(Mark_login.this);
